      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-lg text-gray-600 max-w-2xl mx-auto">
            No vendo plantillas. Diseño landings hechas para <strong>tu</strong>{" "}
            audiencia.
          </p>
        </div>
        ...
        <div className="mb-16">
          ...
          <p className="text-gray-600 mb-6">
            ¿Ofreces un servicio? Tu landing debe transmitir confianza, claridad
            y profesionalismo.
          </p>
        ...
        <div>
          ...
          <p className="text-gray-600 mb-6">
            ¿Eres artista o creador? Tu landing debe reflejar tu estilo, sonido
            o visión.
          </p>
          ...
          >
            <AnimatePresence>
              {(showAllCreators ? creators : creators.slice(0, 2)).map(
                (item, i) => (
                  <motion.div
                    key={item.id}
                    custom={i}
