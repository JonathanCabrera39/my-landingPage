...
export default function Footer({
  ...
  containerClassName = "bg-gray-900 from-blue-950 to-blue-800 text-gray-400 border-t border-gray-800",
  containerStyle,
}: FooterProps) {
              ...
              <div className="flex space-x-4">
                {socialLinks.map((link, index) => (
                  <a
                    ...
                    className="p-2 rounded-full bg-gray-800 text-gray-400 hover:bg-blue-900  hover:text-white transition-all duration-200 transform hover:-translate-y-1"
                  >
