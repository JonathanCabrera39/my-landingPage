...
const DEFAULT_AUTHOR_LINK_CLASSNAME =
  "font-medium text-white hover:text-indigo-400 transition";
const DEFAULT_COPYRIGHT_TEXT_CLASSNAME = "mt-2 text-xs";
const DEFAULT_SOCIAL_AREA_CLASSNAME =
  "mt-4 flex justify-center space-x-6 text-sm";
...
export default function Footer({
  ...
  return (
    <footer
      className={`bg-gray-900 text-gray-400 ${containerClassName}`}
